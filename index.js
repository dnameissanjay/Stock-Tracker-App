...
function fetchTopStocks() {
    // Fetch data from api
    fetch('https://www.alphavantage.co/query?function=SECTOR&apikey=H9FZU8EL17RDMKFB').then(response => response.json()).then(data => {
...
function fetchStockData(symbol) {
    ...
    fetch(`https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${symbol}&apikey=H9FZU8EL17RDMKFB`).then(response => response.json()).then(data => {
